...
1. Download Lua source code, unzip it and copy the entire lua-5.3.0 folder to Engine/Plugins/GKLua/Source/Lua/
2. Open Engine/Plugins/GKLua/Source/Lua/Lua.sln in Visual Studio
