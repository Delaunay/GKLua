...
DEFINE_LOG_CATEGORY(LogGKLuaEditor);
...
public:
	...
	virtual UClass *GetSupportedClass() const override { return ULuaBlueprint::StaticClass(); }
...
{
	return Cast<ULuaBlueprint>(Blueprint) != nullptr;
}
...
{
	if (ULuaBlueprint *ScriptBlueprint = Cast<ULuaBlueprint>(Blueprint))
	{
