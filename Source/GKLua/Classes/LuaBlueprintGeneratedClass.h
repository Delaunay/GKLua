 ...
 * 
 * This is the dynamic class that is generated by blueprints and sits on top of the native implementation
 * overidding and extending it
 * 
 * This needs to keep track of lua created properties
 */
